    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
        ...
        <ul class="mt-4">
            ...
            <li class="mb-1 group">
                ...
                <ul>
                    {{--  <li><a href="{{ route('Admin.dashadmin.category.edite') }}">Update category</a></li>  --}}
                </ul>
            </li>
        </ul>
    </div>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="w-full lg:w-1/2 mb-6 lg:mb-0">
            <div class="bg-white dark:bg-gray-700 rounded-lg shadow-lg">
                <div class="px-6 py-4">
                    <h3 class="font-semibold text-lg text-gray-900 dark:text-gray-50">Categories</h3>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full border-collapse">
                        <thead>
                            <tr class="bg-gray-100 dark:bg-gray-600">
                                <th class="px-4 py-3 text-xs font-semibold text-gray-600 uppercase border-b border-gray-200 dark:border-gray-500">
                                    Name
                                </th>
                                <th class="px-4 py-3 text-xs font-semibold text-gray-600 uppercase border-b border-gray-200 dark:border-gray-500">
                                    Action
                        ...
                        <tbody>
                            @foreach ($Categories as $Categorie)
                                <tr class="text-gray-700 dark:text-gray-100">
                                    <td class="px-4 py-3 border-b border-gray-200 dark:border-gray-500">
                                        {{ $Categorie->name }}
                                    </td>
                                    <td class="px-4 py-3 border-b border-gray-200 dark:border-gray-500">
                                        <form action="{{ route('categories.edit', $Categorie->id) }}" method="post">
                                            @csrf
                                            @method('GET')
