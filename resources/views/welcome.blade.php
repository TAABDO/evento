...
<body class="antialiased">
    ...
    <nav
        class="bg-white dark:bg-white-700 bg-opacity-65 fixed w-full z-20 top-0 start-0 border-b border-gray-300 dark:border-gray-200">
            ...
            @auth
                ...
                <div class="flex items-center md:order-2 space-x-3 gap-10 md:space-x-0 rtl:space-x-reverse">
                    ...
                    <div class="relative">
                        ...
                        <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            <a href="{{ route('participant.index') }}">profil</a>
                        </button>
                        @else(auth()->user()->hasRole('organizer'))
                        <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            ...
            @else
                ...
                <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    ...
                    <a href="{{ route('register') }}"> <button type="button"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button></a>
                    <!-- Mobile Menu Toggle -->
    ...
    <section class="bg-center bg-no-repeat bg-cover bg-gray-700 bg-blend-multiply"
        ...
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">
                EvenTo The Most Complete On The Market</h1>
            <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">EvenTo that adapts precisely
                to your needs and the different formats that your event can have
    ...
    <div
        class="relative flex flex-col items-center mb-20 mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-12 xl:max-w-6xl">
        <div class="w-full h-64 lg:w-1/2 lg:h-auto">
            <img class="h-full w-full object-cover" src="{{ URL::asset('img/161854-edm-festival-wallpaper.jpg') }}"
        ...
        <div
            ...
            <div class="flex flex-col p-12 md:px-16">
                ...
                <p class="mt-4">
                    ...
                    Whether your planning a dream wedding, charity gala, fashion show, outdoor adventure, wellness
                    retreat,
                    gourmet tasting, or extreme sports event,
                    we have got you covered. Let us turn your vision into reality and make your next event truly
                    exceptional.
                </p>
                <div class="">
                    <a href="#"
                        class="inline-block w-full text-center text-lg font-medium text-gray-100 bg-indigo-600 border-solid border-2 border-gray-600 py-4 px-10 hover:bg-green-800 hover:shadow-md md:w-48">Read
                        More
                    </a>
                </div>
            </div>
...
<section class="container my-4">
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
            <label for="titleFilter" class="block mb-1 text-sm font-medium text-gray-700">Search by Title:</label>
        ...
        <div>
            <label for="categoryFilter" class="block mb-1 text-sm font-medium text-gray-700">Filter by Category:</label>
            <select class="w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 form-select"
                id="categoryFilter" onchange="filter()">
...
{{-- End of search input and button --}}
    ...
    <footer class="bg-white rounded-lg shadow dark:bg-gray-900 m-4">
        <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            ...
            <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a
                    href="https://flowbite.com/" class="hover:underline">EvenTo™</a>. All Rights Reserved.</span>
        </div>
    </footer>
    ...
    <script>
        function search() {
            ...
            if(valueInput == ""){
            var url = '/SearchEvent?text=0' ;
        }
        else{
            var url = '/SearchEvent?text=' + valueInput  ;
